...
import {
  bucketCardsByColor,
  bucketCardsByManaValue,
  bucketCardsByTypeCategory,
  defaultTableSort,
  gallerySort,
...
describe("bucketCardsByTypeCategory", () => {
  it("groups cards consistently", () => {
    expect(bucketCardsByTypeCategory(TEST_DATA)).toMatchInlineSnapshot(`
{
  "Artifact": [
    {
      "color": "Multicolored",
...
describe("bucketCardsByManaValue", () => {
  it("groups cards consistently", () => {
    expect(bucketCardsByManaValue(TEST_DATA)).toMatchInlineSnapshot(`
{
  "0": [
    {
      "color": "Land",
